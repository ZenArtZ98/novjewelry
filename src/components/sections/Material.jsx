      ...
      <div className="material__container">
        ...
        <div data-reveal="1">
          ...
          <p className="material__description">
            Вторичный ПНД приходит крышками, ведрами и обрезками. После
            дробления и прессования внутри листа остаются разводы, вкрапления и
            крошка исходного сырья. Это и есть рисунок изделия — повторить его
            невозможно.
          </p>
